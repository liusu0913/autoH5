<template>
  <div id="app">
    <img src="../../assets/dome.jpg" alt="" class="dome">
  </div>
</template>
...
export default {
  ...
  mixins: [mixins],
  async mounted() {
    this.setPageTitle('比起“财富自由“，看病自由”才是中年人攥得住的安全感')
      ...
      if (res.code === 0) {
        ...
        wx.ready(function () {
          ...
          wx.updateAppMessageShareData({ 
            title: '比起“财富自由“，看病自由”才是中年人攥得住的安全感', // 分享标题
            desc: '中宏保险“臻享无忧医疗保障”,更高品质的健康关爱,给与家庭稳稳的“安全感”!', // 分享描述
            link: shareUrl, // 分享链接，该链接域名或路径必须与当前页面对应的公众号JS安全域名一致
            imgUrl: 'https://img-1307195053.cos.ap-nanjing.myqcloud.com/WechatIMG4760.png', // 分享图标
            success: function () {
              // 设置成功
